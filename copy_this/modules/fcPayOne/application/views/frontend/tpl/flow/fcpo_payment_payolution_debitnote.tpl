<dl>
    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input class="form-control js-oxValidate js-oxValidate_notEmpty"  type="text" size="20" maxlength="64" name="dynvalue[fcpo_payolution_accountholder]" value="[{$dynvalue.fcpo_payolution_accountholder}]" onkeyup="fcHandleDebitInputs();return false;" required="required">
            </div>
        </div> 
        <div class="form-group">
            <label class="req control-label col-lg-3">[{oxmultilang ident="FCPO_BANK_IBAN"}]</label>
            <div class="col-lg-9">
                <input class="form-control js-oxValidate js-oxValidate_notEmpty" type="text" size="20" maxlength="64" name="dynvalue[fcpo_payolution_iban]" value="[{$dynvalue.fcpo_payolution_iban}]" onkeyup="fcHandleDebitInputs();return false;" required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-9">
                <input class="form-control js-oxValidate js-oxValidate_notEmpty" autocomplete="off" type="text" size="20" maxlength="64" name="dynvalue[fcpo_payolution_bic]" value="[{$dynvalue.fcpo_payolution_bic}]" onkeyup="fcHandleDebitInputs();return false;" required="required">
